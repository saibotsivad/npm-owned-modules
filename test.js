...
test('callback method', function(t) {
	ownedModules('npmupdater', function(err, modules) {
		assertModulesList(t, err, modules)
	})
})

test('promise method', function(t) {
	ownedModules('npmupdater').then(function(modules) {
		assertModulesList(t, undefined, modules)
	})
})

function assertModulesList(t, err, modules) {
